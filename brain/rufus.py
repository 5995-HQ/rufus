...
inquiry_words = ["who", "what", "why", "where", "when", "how", "can", "will", "yo", "sup", "when is", "when did",
                 "why is", "what is"]
print("\n" + "#"*20 + " Say something " + "#"*20 + "\n")
while True:
    words = recordAudio()
    ...
    elif words.startswith("hey Rufus") or words.startswith("a Rufus") or words.startswith("Rufus") or words in inquiry_words:
